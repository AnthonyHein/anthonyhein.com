...
const defaultSchoolData: School[] = [
  {
  ...
  {
    name: "JFK Memorial High School (Iselin, NJ)",
    cumulativeGPA: "4.33 / 4.33",
    attended: "2014 - 2018",
    honors: [
      { text: "Valedictorian", link: "https://youtu.be/tye-XioSlWg?t=595" },
      { text: "Mr. JFK", link: "https://youtu.be/DSCRt7CWLWE?t=3996" },
      {
...
export default defaultSchoolData;
